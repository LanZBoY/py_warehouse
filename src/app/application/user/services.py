...
from src.app.core.security.auth import verify_password, create_access_token, hash_password
...
class UserService:
    ...
    async def get_users(self, skip: int = 0, limit: int = 10) -> tuple[list[UserRead], int]:
    ...
    async def create_user(self, username: str, password: str, creator_id: uuid.UUID) -> UserRead:
